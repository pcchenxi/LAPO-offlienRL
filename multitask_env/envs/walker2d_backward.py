...
class Walker2dBackwardEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self, backward=True, task_one_hot_id=None):
    ...
    def get_normalized_score(self, score):
        min_score = 2.0027373 * 1000
        max_score = 4.428209 * 1000

        return (score - min_score)/(max_score-min_score)

    def get_dataset(self):
        home = str(Path.home())
        with open(home + "/.d4rl/datasets/multi-walker2d-backward-v1.pkl", 'rb') as handle:
